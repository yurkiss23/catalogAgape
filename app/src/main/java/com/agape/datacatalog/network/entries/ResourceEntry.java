...
public class ResourceEntry {
    ...
    public static List<ResourceEntry> initResourcesEntryList(Resources resources) {
        ...
        String jsonResourcesString = writer.toString();
        Gson gson = new Gson();
        Type resourceListType = new TypeToken<ArrayList<ResourceEntry>>() {
        }.getType();
        return gson.fromJson(jsonResourcesString, resourceListType);
    }
}
